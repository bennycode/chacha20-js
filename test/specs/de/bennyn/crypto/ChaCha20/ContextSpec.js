...
describe('ChaCha20Poly1305 Test Vectors', function () {
  it('handles 256-bit keys with 64-bit nonces', function () {
    ...
    var vector = new de.bennyn.crypto.ChaCha20.Vector(testVector.key, testVector.nonce, testVector.prefix);
    var context = new de.bennyn.crypto.ChaCha20.Context(vector.getKey().getBufferView(), vector.getNonce().getBufferView());
    context.generateKeyStream(vector.getKeyStreamLength());
